...
# name, pen, dmg, mag, rof, weight, length, equip, bul_acc, hip_acc, aim_acc, run_acc, **attachments
...
com_18 = Weapon('COM-18', 55, 21.2, 15, 420, 0.72, 19, 0.26, 0.2, 1.7, 0.23, 2.4,
...
fsp_9 = Weapon('FSP-9', 35, 22.3, 30, 690, 2.45, 45, 0.38, 0.17, 1.7, 0.4, 2.5,
...
crossvec = Weapon('Crossvec', 25, 23.5, 40, 750, 2.65, 61, 1.27, 0.17, 1.7, 0.2, 2.8,
...
mtf_e11_sr = Weapon('MTF-E11-SR', 70, 25.1, 40, 570, 3.15, 87, 0.73, 0.05, 2, 0.08, 5.8,
...
fr_mg_0 = Weapon('FR-MG-0', 80, 22.9, 100, 750, 7.2, 102, 0.8, 0.05, 3.5, 0.08, 10.9,
...
ak = Weapon('AK', 85, 26.2, 30, 498, 3.9, 96, 0.54, 0.07, 2.5, 0.08, 7.4,
...
logicer = Weapon('Logicer', 90, 26.8, 100, 660, 11.3, 115, 0.93, 0.035, 3.5, 0.15, 16.6,
...
shotgun = Weapon('Shotgun', 70, 66.64, 14, 100, 3.95, 74, 0.58, 0, 0.6, 0.1, 4.,
...
revolver = Weapon('.44 Revolver', 65, 57.77, 6, 240, 2.15, 34, 0.45, 0.15, 2, 0.75, 2.7,
